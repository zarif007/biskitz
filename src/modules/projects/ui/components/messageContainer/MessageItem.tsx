    ...
    return (
        ...
        >
            <div className="flex-shrink-0">
                <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center ${isAssistant
            ...
            <div className="flex-1 max-w-[80%]">
                <Card
                    className={`shadow-none gap-2 border-0 bg-transparent ${isAssistant
                            ? 'p-0 my-2'
                ...
                >
                    {message.content && (
                        <p
                            className={`text-sm leading-relaxed ${isAssistant
                    ...
                    {message.fragment && (
                        <div
                            className={`p-2 rounded-sm bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 ${activeFragment &&
                    ...
                    {message.events && message.events.length > 0 && (
                        <div className="mt-0 space-y-1">
                            {message.events.map((event, eventIndex) => (
                                <p key={eventIndex} className="text-xs w-full p-[6] bg-transparent text-gray-700 dark:text-gray-300 underline">
                                    {event}
                                </p>
                            ))}
                        </div>
                ...
                <div
                    className={`flex items-center gap-1 mt-1 text-xs text-gray-500 dark:text-gray-400 ${isAssistant ? 'justify-start' : 'justify-end'
                        }`}
                >
